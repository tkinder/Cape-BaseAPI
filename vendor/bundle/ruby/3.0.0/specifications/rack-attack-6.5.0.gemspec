# -*- encoding: utf-8 -*-
# stub: rack-attack 6.5.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rack/rack-attack/issues", "changelog_uri" => "https://github.com/rack/rack-attack/blob/master/CHANGELOG.md", "source_code_uri" => "https://github.com/rack/rack-attack" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<railties>.freeze, [">= 4.2", "< 6.2"])
  else
    ...
    s.add_dependency(%q<railties>.freeze, [">= 4.2", "< 6.2"])
  end
end
